...
/* Sample Error
tfazs-MacBook-Pro:v7-terraform-manifests-lifecycle-prevent_destroy kexamples$ terraform apply -auto-approve
...
╵
tfazs-MacBook-Pro:v7-terraform-manifests-lifecycle-prevent_destroy kexamples$ 
*/