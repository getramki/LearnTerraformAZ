...
substr("tf-az examples", 1, 4)
substr("tf-az examples", 0, 6)
substr("tf-az examples", 0, 1)
substr("tf-az examples", 0, 0)
substr("tf-az examples", 0, 10)
```
...
lower("TERRAFORM WORKS")
lower("tf-az-examples")

# Test upper() function
Template: lower("string")
upper("TERRAFORM WORKS")
upper("tf-az-examples")
```
