...
# Terraform console
terraform console
element(["tfaz", "works", "examples"], 0)
element(["tfaz", "works", "examples"], 1)
element(["tfaz", "works", "examples"], 2)

# To get last element from list
length(["tfaz", "works", "examples"])
element(["tfaz", "works", "examples"], length(["tfaz", "works", "examples"])-1)
```
